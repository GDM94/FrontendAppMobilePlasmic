...
import Topbar from "../../Topbar"; // plasmic-import: xLJRmZlMxT/component
...
import * as sty from "./PlasmicHomepage.module.css"; // plasmic-import: 4DQxbyq351Fv/css
...
const PlasmicDescendants = {
  root: ["root", "topbar", "descriptionText", "box"],
  topbar: ["topbar"],
  descriptionText: ["descriptionText", "box"],
  box: ["box"]
};
